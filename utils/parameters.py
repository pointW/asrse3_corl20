...
training_group.add_argument('--ddpg_bc_q_filter', type=strToBool, default=False)
training_group.add_argument('--critic_fc', type=str, default='1024*3')
training_group.add_argument('--q3_input', type=str, default='proj', choices=['crop', 'proj'])
...
planner_config = {'pos_noise': planner_pos_noise, 'rot_noise': planner_rot_noise, 'random_orientation':random_orientation,}
if seed is not None:
